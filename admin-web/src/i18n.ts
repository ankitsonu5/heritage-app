...
const copy: Record<string, [string, string]> = {
  ...
  delete: ['Delete', 'हटाएं'],
  action: ['Action', 'एक्शन'],
  confirmDeleteUser: ['Delete “%s”? Their orders and reports go too. This cannot be undone.', '“%s” को हटाएं? इनके ऑर्डर और रिपोर्ट भी हट जाएंगे। यह वापस नहीं होगा।'],
  userDeleted: ['User deleted (%s orders removed)', 'यूज़र हटाया गया (%s ऑर्डर हटे)'],
